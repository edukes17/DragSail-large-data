function [a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,aa,bb] = PropertiesFile(FN)
...
idx9 = find(contains(matData{1}, 'transmissivity_coef'),1);
idx10 = find(contains(matData{1}, 'Refl'),1);
idx11 = find(contains(matData{1}, 'mass'),1);
idx12 = find(contains(matData{1}, 'inertia'),1);
idx13 = find(contains(matData{1}, 'cm'),1);
idx14 = find(contains(matData{1}, 'Semimajor'),1);
idx15 = find(contains(matData{1}, 'Eccentricity'),1);
idx16 = find(contains(matData{1}, 'Inclination'),1);
idx17 = find(contains(matData{1}, 'Argument'),1);
idx18 = find(contains(matData{1}, 'Ascension'),1);
idx19 = find(contains(matData{1}, 'True Anomaly'),1);
idx20 = find(contains(matData{1}, 'Output Directory'),1);
idx21 = find(contains(matData{1}, 'Roll angle'),1);
idx22 = find(contains(matData{1}, 'Pitch angle'),1);
idx23 = find(contains(matData{1}, 'Yaw angle'),1);
idx24 = find(contains(matData{1}, 'Roll rate'),1);
idx25 = find(contains(matData{1}, 'Pitch rate'),1);
idx26 = find(contains(matData{1}, 'Yaw rate'),1);
idx27 = find(contains(matData{1}, 'Epoch'),1);
idx28 = find(contains(matData{1}, 'Propagation'),1);
...
j = str2double(info(idx10,2));
k = str2double(info(idx11,2));
...
y = str2double(info(idx25,2));
z = str2double(info(idx26,2));
aa =(info(idx27,2));
bb = str2double(info(idx28,2));
end