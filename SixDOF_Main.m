...
%prompt = {'Enter Operating System (PC or Mac)'}; %Not needed, Matlab has
%internal function
%dlgtitle = 'Operating System';
%dims = [1 40];
%definput = {'PC'};
...
[FN,tmp,ref,spec,fem,bem,fnL,bnL,tran,Refl,mass,in,cm,SMA,ecc,inc,arg,asc,TA,od,phi,theta,psi,phidot,thdot,psidot,ep,prop] = PropertiesFile(FileName);
...
Time_propagation            = prop;                     % Duration of propagation [seconds]
